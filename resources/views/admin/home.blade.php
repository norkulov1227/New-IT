          ...
          <div class="col-md-12 col-lg-4 ">
            ...
            <div class="card mb-4">
              <div class="card-body">
                ...
                <button class="btn btn-flat grey lighten-3 btn-rounded waves-effect float-right font-weight-bold dark-grey-text">View
                  full report</button>
          ...
          <div class="col-lg-8 col-md-12">
            ...
            <div class="card mb-4">
              <div class="card-body">
                ...
                <button class="btn btn-flat grey lighten-3 btn-rounded waves-effect font-weight-bold dark-grey-text float-right">View
                  full report</button>
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="progress">
                  <div class="progress-bar grey darken-2" role="progressbar" style="width: 45%" aria-valuenow="25"
          ...
          <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="progress">
                  <div class="progress-bar grey darken-2" role="progressbar" style="width: 65%" aria-valuenow="65"
                    aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <!--Text-->
                <p class="font-small grey-text">Better than last week (25%)</p>
