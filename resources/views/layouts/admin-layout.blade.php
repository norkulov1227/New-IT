      ...
      <ul class="custom-scrollbar">
        ...
        <li class="logo-sn waves-effect">
          <div class="text-center">
            <a href="{{route('admin.home')}}" class="pl-0"><img src="https://mdbootstrap.com/img/logo/mdb-transaprent-noshadows.png" class=""></a>
          </div>
        </li>
        <!--/. Logo -->
        ...
        <li>
          <ul class="collapsible collapsible-accordion">
            <li>
                <a href="{{route('admin.home')}}" class="collapsible-header waves-effect arrow-r">
            ...
            <li>
                <a href="{{route('admin.product.index')}}" class="collapsible-header waves-effect arrow-r">
